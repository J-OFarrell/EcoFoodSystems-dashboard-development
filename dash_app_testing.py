...
sidebar = dbc.Card([
    html.Img(src="/assets/logos/temp_efs_logo.png", style={"width": "80%", "margin-bottom": "10px", "justifyContent": "center"}),
    dbc.Nav([
        dbc.NavItem(dbc.NavLink("Stakeholders", id="tab-1-stakeholders", href="#", active="exact"), style=tabs_style),
        dbc.NavItem(dbc.NavLink("Poverty", id="tab-2-mpi", href="#", active="exact"), style=tabs_style),
        dbc.NavItem(dbc.NavLink("Affordability", id="tab-3-affordability", href="#", active="exact"), style=tabs_style),
        dbc.NavItem(dbc.NavLink("Nutrition", id="tab-4-nutrition", href="#", active="exact"), style=tabs_style),
        dbc.NavItem(dbc.NavLink("Supply", id="tab-5-supply", href="#", active="exact"), style=tabs_style),
        dbc.NavItem(dbc.NavLink("Shocks", id="tab-6-shocks", href="#", active="exact"), style=tabs_style),
    ], 
    vertical="md", 
    pills=True, 
    fill=True,
...
app.layout = html.Div([
            ...
            html.Div([
                    ...
                    html.Div(id="tab-content", children=poverty_tab_layout(), style={"width": "85%",
                                                                                    "height": "100%"})
            ...
            # Footer
            #html.Div([footer], style={"width": "100%", "flex": "0 0 auto", "margin-top":'20px'}),
...
@app.callback(
    ...
    [
        ...
        Input("tab-2-mpi", "n_clicks"),
        Input("tab-3-affordability", "n_clicks"),
        Input("tab-4-nutrition", "n_clicks"),
        Input("tab-5-supply", "n_clicks"),
        Input("tab-6-shocks", "n_clicks"),
    ]
)
def render_tab_content(n1, n2, n3, n4, n5, n6):
    ...
    elif tab_id == "tab-2-mpi":
        return poverty_tab_layout()
    elif tab_id == "tab-3-affordability":
        return affordability_tab_layout()
    elif tab_id == "tab-4-nutrition":
        return html.Div([html.H2("Nutrition - Coming Soon")])
    elif tab_id == "tab-5-supply":
        return supply_tab_layout()
    elif tab_id == "tab-6-shocks":
        return html.Div([html.H2("BioPhysical Shocks - Coming Soon")])
    else:
